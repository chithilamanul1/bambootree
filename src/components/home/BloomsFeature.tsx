    ...
    <section className="w-full bg-[var(--paper-alt)] py-16 lg:py-24">
      <div className="mx-auto grid max-w-7xl items-center gap-8 px-6 lg:grid-cols-2 lg:gap-12 lg:px-10">
        ...
        >
          ...
          <div className="absolute -bottom-5 -right-5 hidden rounded-2xl bg-[var(--paper)] px-6 py-4 shadow-lg sm:block">
            <p className="font-serif-display text-2xl italic text-[var(--forest)]">Blooms</p>
            <p className="text-xs uppercase tracking-[0.2em] text-[var(--muted)]">by Bamboo Tree</p>
          </div>
        </motion.div>
        ...
        >
          <span className="inline-flex items-center gap-2 text-xs font-medium uppercase tracking-[0.25em] text-[var(--forest)]">
          ...
          <p className="mt-4 max-w-md text-base leading-relaxed text-[var(--muted)] lg:mt-5 lg:text-lg">
